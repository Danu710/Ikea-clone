      ...
      <div className="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
        <form onSubmit={fnSubmit}>
          ...
          <div className="flex flex-col mb-4">
            <label htmlhtmlFor="completeName" className="text-sm mb-2">
              Complete Name
            </label>
            <input
          ...
          <div className="flex flex-col mb-4">
            <label htmlhtmlFor="address" className="text-sm mb-2">
              Address
            </label>
            <input
              onChange={fnUpdateState}
          ...
          <div className="flex flex-col mb-4">
            <label htmlhtmlFor="phone-number" className="text-sm mb-2">
              Phone Number
            </label>
            <input
              onChange={fnUpdateState}
