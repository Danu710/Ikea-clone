                ...
                return (
                  <div
                    ...
                    <div
                      className={[
                        "item",
                        slider === item ? "bg-red-700 selected" : "",
                      ].join(" ")}>
                      <img
                        src={item}
                        alt={item}
          ...
          <div className="lg:sticky lg:top-0">
            <div className="p-4 bg-gray-100 border rounded">
              <p className="text-sm">
                ...
                <Link to={""} className="inline-block mt-1 underline">
                  {" "}
                  Find out more{" "}
                </Link>
              </p>
            ...
            <button
              ...
              className="inline-flex px-16 py-3 mt-4 text-white uppercase transition-all duration-200 bg-red-700 rounded sm:w-full sm:px-16 focus:bg-black focus:text-red-700">
              <svg
